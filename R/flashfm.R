...
#' @param covY trait covariance matrix
#' @param ss.stats output from summary.stats; list of 4 components: Mx = mean of SNPs, xcovo = covariance matrix of SNPs, Sxy = matrix of Sxy values (column traits), ybar=vector of trait means 
